...
return [
    ...
    [
        ...
        'key'    => 'sales.payment_methods.pagbank_standard',
        'name'   => 'admin::app.configuration.index.sales.payment-methods.pagbank-standard',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.pagbank-standard-info',
        'sort'   => 3,
        'fields' => [
            [
                'name'          => 'title',
        ...
        'key'    => 'sales.payment_methods.pagbank_smart_button',
        'name'   => 'admin::app.configuration.index.sales.payment-methods.pagbank-smart-button',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.pagbank-smart-button-info',
        'sort'   => 0,
        'fields' => [
            [
                'name'          => 'title',

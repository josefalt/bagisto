...
class Standard extends PagBank
{
    /**
     * Payment method code.
     *
     * @var string
     */
    protected $code = 'pagbank_standard';
    ...
    {
        return route('pagbank.standard.redirect');
    }

    /**
     * Return pagbank IPN url.
     *
     * @return string
     */
    public function getIPNUrl()
    {
        return $this->getConfigData('sandbox')
            ? 'https://ipnpb.sandbox.pagbank.com/cgi-bin/webscr'
            : 'https://ipnpb.pagbank.com/cgi-bin/webscr';
    }
    ...
    public function getFormFields()
    {
        ...
        $fields = [
            ...
            'paymentaction'   => 'sale',
            'return'          => route('pagbank.standard.success'),
            'cancel_return'   => route('pagbank.standard.cancel'),
            'notify_url'      => route('pagbank.standard.ipn'),
            'charset'         => 'utf-8',

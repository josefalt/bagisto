...
namespace Webkul\PagBank\Listeners;

use Webkul\PagBank\Payment\SmartButton;
...
class Transaction
{
    ...
    public function saveTransaction($invoice)
    {
        ...
        if ($invoice->order->payment->method == 'pagbank_smart_button') {
        ...
        } elseif ($invoice->order->payment->method == 'pagbank_standard') {
            $this->orderTransactionRepository->create([

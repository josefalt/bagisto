...
namespace Webkul\PagBank\Helpers;

use Webkul\PagBank\Payment\Standard;
...
class Ipn
{
    ...
    public function __construct(
        protected Standard $pagbankStandard,
        protected OrderRepository $orderRepository,
        protected InvoiceRepository $invoiceRepository
    ) {}

    /**
     * This function process the IPN sent from pagbank end.
     *
     * @param  array  $post
    ...
    /**
     * Post back to PagBank to check whether this request is a valid one.
     *
     * @return bool
     */
    protected function postBack()
    {
        $url = $this->pagbankStandard->getIPNUrl();
